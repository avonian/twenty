...
import { SyncNoteFieldCommentFieldsCommand } from 'src/database/commands/upgrade-version-command/2-14/2-14-workspace-command-1799000067000-sync-note-field-comment-fields.command';
...
@Module({
  ...
  providers: [
    ...
    SyncNoteFieldCommentFieldsCommand,
  ],
})
