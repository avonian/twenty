...
import { AddAlwaysOpenRecordInRecordPageToWorkspaceFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-14/2-14-instance-command-fast-1781600000000-add-always-open-record-in-record-page-to-workspace';
...
export const INSTANCE_COMMANDS = [
  ...
  AddAlwaysOpenRecordInRecordPageToWorkspaceFastInstanceCommand,
];
